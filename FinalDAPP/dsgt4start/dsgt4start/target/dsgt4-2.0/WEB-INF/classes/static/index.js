...
function fetchAndPopulateWines() {
    fetch("/wines")
        ...
        .then(data => {
            ...
            // Loop through the wines and add options to the select element
            data.forEach(wine => {
                const option = document.createElement("option");
                option.value = wine.name; // Set the value of the option to the wine's name
                option.textContent = wine.name; // Set the text content of the option to the wine's name
