...
import io.liquormenu.gt.webservice.GetLiquorCardRequest;
import io.liquormenu.gt.webservice.GetLiquorCardResponse;
...
public class MenuEndpoint {
    ...
    private final LiquorRepository liquorRepo;
    ...
    @ResponsePayload
    public GetLiquorCardResponse getLiquorCard(@RequestPayload GetLiquorCardRequest request) {
