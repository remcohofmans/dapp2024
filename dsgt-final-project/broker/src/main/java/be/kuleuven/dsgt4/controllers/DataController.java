...
public class DataController {
    ...
    private List<Object> fetchLiquorData() throws Exception {
        try {
            return webClient.get()
                    .uri("http://dappvm.eastus.cloudapp.azure.com:12000/api/liquor-info")
                    .retrieve()
            ...
            System.err.println("Error fetching liquor data: " + e.getMessage());
            throw e;
        }
    }

    // Function to fetch data from the second URL (wines)
    private List<Object> fetchWineData() throws Exception {
        try {
            return webClient.get()
                    .uri("http://localhost:8080/wines")
                    .retrieve()
                    .bodyToFlux(Object.class)
                    .collectList()
                    .block(); // Block to wait for the response
            ...
            System.err.println("Error fetching wine data: " + e.getMessage());
            throw e;
        }
    }

    // Function to request a delivery service
    @GetMapping("/api/askDelivery")
    public String askDelivery(@RequestParam("basketWines") List<String> basketWines) {
        try {
            ...
            String block = webClient.get()
                    .uri("http://dapp.southafricanorth.cloudapp.azure.com:13000/rest/delivery/rest/f1e2d3c4-b5a6-7890-1234-56789abcdef0/overviewOfAlldelivery/8889")
                    .retrieve()
                    .bodyToMono(String.class)
                    .block();
        ...
        return "Sorry, the delivery would not take place";
    }
